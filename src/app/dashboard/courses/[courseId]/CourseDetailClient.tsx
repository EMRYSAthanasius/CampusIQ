        ...
        <div className="flex-1 overflow-y-auto px-8 py-8">
          <div className="max-w-[1200px] mx-auto space-y-8">
            ...
            <motion.div
              ...
              className="p-8 rounded-3xl border border-white/[0.06] relative overflow-hidden"
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                            <div className="flex-1">
                              <div className="flex flex-wrap items-center gap-2 mb-2">
                                ...
                                {isLocked && (
                                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-amber-500/10 text-amber-400 border border-amber-500/20 uppercase tracking-wider flex items-center gap-1">
                              ...
                              <div className="flex items-center gap-4 mt-3 text-xs text-[#9CA3AF]">
                                ...
                                {attempt && (
                                  <span className="flex items-center gap-1">
                                    ...
                                    <span className="text-slate-700">• {formatDate(attempt.date)}</span>
                                  </span>
                                )}
                              </div>
                            </div>
                            ...
                            {isLocked ? (
                              <Link href="/dashboard/upgrade">
                                <button className="px-5 py-2.5 bg-amber-500/10 border border-amber-500/20 text-amber-400 text-sm font-semibold rounded-xl hover:bg-amber-500/20 transition-all flex items-center gap-2 shrink-0">
